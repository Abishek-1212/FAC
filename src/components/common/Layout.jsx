...
export default function Layout({ children, navItems, title }) {
  ...
  const hideHeader = location.pathname === '/admin/jobs' || location.pathname === '/admin/invoices' || location.pathname === '/admin/verify-stock' || location.pathname === '/admin/reports' || location.pathname === '/admin/employees' || location.pathname === '/admin/follow-up' || location.pathname === '/admin/attendance' || location.pathname === '/admin/generate-invoice'
